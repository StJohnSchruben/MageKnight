...
{
    /// <summary>
    /// Represents a service host instance for the <see cref="IQueryContract" />.
    /// </summary>
    /// <seealso cref="Service.QueryContractBase" />
    [ServiceBehavior(ConcurrencyMode = ConcurrencyMode.Multiple, InstanceContextMode = InstanceContextMode.Single)]
    public class QueryService : QueryContractBase, IQueryContract
    {
    }
}